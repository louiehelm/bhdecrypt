...
select case ext_hc
	...
	case 2 'columnar rearrangement azd beam
		bbest=0
		ext_bhd_beam_columnarrearrangement(tn,l,s,solvesub_ctcolumns)
		bm=extcip(tn,1,0)
	...
	case 4 'columnar transposition azd beam
		bbest=0
		ext_bhd_beam_columnartransposition(tn,l,s,solvesub_ctcolumns)
		bm=extcip(tn,1,0)
	case 5 'nulls and skips azd beam
		bbest=0
		ext_bhd_beam_nullsandskips(tn,l,s,solvesub_pnkl)
		bm=extcip(tn,1,0)
end select